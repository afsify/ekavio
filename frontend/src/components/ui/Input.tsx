    ...
    <div className="w-full space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          } bg-slate-900/70 py-3 ${
            icon ? 'pl-10 pr-4' : 'px-4'
          } text-sm text-white placeholder-slate-500 shadow-inner focus:outline-none focus:ring-2 transition duration-200 disabled:opacity-50 min-h-[44px] ${className}`}
          {...props}
        />
      </div>
